...
import { ClearDeletedPhotos, LoadPhotos, LoadMorePhotos, LoadMonthsSummary, SetActiveMonth, SetSortMode } from '../../state/photos/photos.actions';
import { StartDeletionJob } from '../../state/jobs/jobs.actions';
import { buildGroupsFromPhotos, Granularity } from './photo-groups.utils';
...
export class PhotosComponent implements OnInit, OnDestroy {
  ...
  groups = computed<PhotoGroup[]>(() => buildGroupsFromPhotos(this.filteredPhotos(), this.granularity(), this.groupingMode(), this.sortMode()));
